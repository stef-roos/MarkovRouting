...
public class FailureAlpha4Beta1Lower extends KadTypeLower{
	double fprob;
	private int ttl;
	
	public FailureAlpha4Beta1Lower(int b, int[] k, double[][] l,
	...
	public FailureAlpha4Beta1Lower(int b, int[] k, int l, double fprob, int ttl) {
		super(b, 4, 1, k, l);
		this.fprob = fprob;
		this.ttl = ttl;
	}
