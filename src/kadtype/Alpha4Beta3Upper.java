							...
							for (int j2 = j1; j2 < this.cdfs[old[0]].length; j2++) {
								...
								for (int j3 = j2; j3 < this.cdfs[old[0]].length; j3++) {
									...
									for (int k1 = 0; k1 < this.cdfs[old[2]].length; k1++) {
										returned[2][0] = k1;
										for (int k2 = 0; k2 < this.cdfs[old[2]].length; k2++) {
											returned[2][1] = k2;
											for (int k3 = 0; k3 < this.cdfs[old[2]].length; k3++) {
												returned[2][2] = k3;
												double p3 = this.getProb(
														returned[2], old[2]);
												for (int m1 = 0; m1 < this.cdfs[old[2]].length; m1++) {
													returned[3][0] = m1;
													for (int m2 = 0; m2 < this.cdfs[old[3]].length; m2++) {
														returned[2][1] = m2;
														for (int m3 = 0; m3 < this.cdfs[old[3]].length; m3++) {
															returned[3][2] = m3;
															double p4 = this
																	.getProb(
																			returned[3],
