...
public class Alpha4Beta1UpperMult extends KadTypeUpper2 {
	
	public Alpha4Beta1UpperMult(int b, int[] k, double[][] l,
			LType ltype) {
		super(b, 4, 1, k, l, ltype);
	}
	
	public Alpha4Beta1UpperMult(int b, int[] k, int l) {
		super(b, 4, 1, k, l);
	}
